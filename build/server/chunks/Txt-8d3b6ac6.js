...
var Txt_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".pointer.svelte-1qevznt{cursor:pointer}.small.svelte-1qevznt{color:grey;font-size:0.75rem}.head-space.svelte-1qevznt{height:0.5rem}.head.svelte-1qevznt{font-size:0.875rem;line-height:1.125em;font-weight:600;letter-spacing:0.16px}")();
const css = {
  code: ".pointer.svelte-1qevznt{cursor:pointer}.small.svelte-1qevznt{color:grey;font-size:0.75rem}.head-space.svelte-1qevznt{height:0.5rem}.head.svelte-1qevznt{font-size:0.875rem;line-height:1.125em;font-weight:600;letter-spacing:0.16px}",
  map: null
};
  ...
  do {
    ...
    $$rendered = `${validate_component(Row, "Row").$$render($$result, { noGutter: true }, {}, {
      default: () => {
        return `${validate_component(Column, "Column").$$render($$result, {}, {}, {
          default: () => {
            return `<span>${title ? `<div class="${"head svelte-1qevznt"}">${validate_component(Truncate, "Truncate").$$render($$result, { clamp: "end" }, {}, {
              default: () => {
                return `${escape(title)}`;
              }
            })}</div>` : ``}
      ${txt ? `${txt.joined ? `<p class="${"pointer svelte-1qevznt"}">${escape(leaveText)}</p>` : `<p class="${"pointer svelte-1qevznt"}">Join this txt</p>`}` : ``}
      <br></span>
    <div class="${"head-space svelte-1qevznt"}"></div>`;
          }
        })}`;
      }
    })}
      ...
      return `${validate_component(Row, "Row").$$render($$result, { noGutter: true }, {}, {
        default: () => {
          return `${validate_component(Column, "Column").$$render($$result, {}, {}, {
            default: () => {
              var _a;
              return `<p class="${"small pointer svelte-1qevznt"}">${escape((_a = item.user) == null ? void 0 : _a.username)}</p>
