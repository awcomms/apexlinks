...
import { a as notify } from "./index-cf6f227c.js";
import { w as writable } from "./HeaderSearch.svelte_svelte_type_style_lang-6a6eb170.js";
...
${open ? `${tags.length > 0 ? `${validate_component(Tag_1, "Tag").$$render($$result, { type: "magenta" }, {}, {
      default: () => {
        return `Clear`;
      }
    })}` : ``}
  ${each(tags, (tag) => {
      return `${hidable ? `${validate_component(ContextMenu, "ContextMenu").$$render($$result, { target: tag.ref }, {}, {
        default: () => {
